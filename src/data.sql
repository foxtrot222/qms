...
CREATE TABLE `token` (
  ...
  `customer_id` int unsigned NOT NULL,
  `type` enum('appointment','walkin','billing','complaint','kyc') DEFAULT NULL,
  `status` enum('pending','serving','completed','late') NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-10-11 17:42:29
